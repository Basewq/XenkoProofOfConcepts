...
{
    public class GameScreenController : SyncScript
    {
        public const string EntityName = "GameScreenController";

        private UIComponent _uiComponent;

        public GameScreenBase GameScreen;
        ...
        {
            GameScreen.Initialize(Entity, gameScreenManager);
            IsInitialized = true;
        }
        ...
        private void AdjustVirtualResolution(object sender, EventArgs e)
        {
            ...
            GameScreen.OnScreenSizeChanged(backBufferSize);
        }
