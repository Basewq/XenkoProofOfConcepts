...
{
    //[DataContract("BepuCharacterComponent")]
    //[Display("Character (Bepu)")]
    //public sealed class BepuCharacterComponent : BepuPhysicsComponent
    //{
    //    [DataMemberIgnore]
    //    internal System.Numerics.Vector3 InternalGravity;

    //    public BepuCharacterComponent()
    //    {
    ...
    //        Simulation.AddCharacter(this, (CollisionFilterGroupFlags)CollisionGroup, CanCollideWith, CollidableMobility.Kinematic);
    //    }
