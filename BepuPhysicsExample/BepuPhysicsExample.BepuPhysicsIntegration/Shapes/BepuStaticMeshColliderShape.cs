...
{
    //public class BepuStaticMeshColliderShape : BepuColliderShape
    //{
    ...
    //    /// </summary>
    //    public BepuStaticMeshColliderShape(ICollection<Vector3> vertices, ICollection<int> indices, Vector3 scaling) : this(vertices.ToArray(), indices.ToArray(), scaling)
    //    {
    ...
    //    /// </summary>
    //    BepuStaticMeshColliderShape(Vector3[] verticesParam, int[] indicesParam, Vector3 scaling)
    //    {
