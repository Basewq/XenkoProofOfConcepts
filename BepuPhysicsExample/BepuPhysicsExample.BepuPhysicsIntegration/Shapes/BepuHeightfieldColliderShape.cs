...
{
    //public class BepuHeightfieldColliderShape : BepuColliderShape
    //{
    //    public BepuHeightfieldColliderShape(int heightStickWidth, int heightStickLength, UnmanagedArray<short> dynamicFieldData, float heightScale, float minHeight, float maxHeight, bool flipQuadEdges)
    ...
    //    public BepuHeightfieldColliderShape(int heightStickWidth, int heightStickLength, UnmanagedArray<byte> dynamicFieldData, float heightScale, float minHeight, float maxHeight, bool flipQuadEdges)
    ...
    //    public BepuHeightfieldColliderShape(int heightStickWidth, int heightStickLength, UnmanagedArray<float> dynamicFieldData, float heightScale, float minHeight, float maxHeight, bool flipQuadEdges)
    ...
    //    internal BepuHeightfieldColliderShape
    //    (
    ...
    //                InternalShape = new HeightfieldTerrainShape(HeightStickWidth, HeightStickLength, ShortArray.Pointer, HeightScale, MinHeight, MaxHeight, 1, PhyScalarType.Int16, flipQuadEdges)
    //                {
    ...
    //                InternalShape = new HeightfieldTerrainShape(HeightStickWidth, HeightStickLength, ByteArray.Pointer, HeightScale, MinHeight, MaxHeight, 1, PhyScalarType.Byte, flipQuadEdges)
    //                {
    //                    LocalScaling = cachedScaling,
    //                };
    ...
    //                InternalShape = new HeightfieldTerrainShape(HeightStickWidth, HeightStickLength, FloatArray.Pointer, HeightScale, MinHeight, MaxHeight, 1, PhyScalarType.Single, flipQuadEdges)
    //                {
    //                    LocalScaling = cachedScaling,
    //                };
    ...
    //    {
    //        set { ((HeightfieldTerrainShape)InternalShape).SetUseDiamondSubdivision(value); }
    //    }

    //    public bool UseZigzagSubdivision
    //    {
    //        set { ((HeightfieldTerrainShape)InternalShape).SetUseZigzagSubdivision(value); }
    //    }
    ...
    //        private BepuHeightfieldColliderShape heightfield;

    //        private HeightfieldDebugPrimitive(BepuHeightfieldColliderShape heightfieldColliderShape)
    //        {
    ...
    //        public static HeightfieldDebugPrimitive New(GraphicsDevice device, BepuHeightfieldColliderShape heightfieldColliderShape)
    //        {
